...
namespace Easy\Framework\Console\Commands;
...
class InstallFramework extends Command
{
     ...
     * @var string
     */
    protected $signature = 'easy:publish-project  {--composer=global : Absolute path to the Composer binary which should be used to install packages}';
     ...
     * @var string
     */
    protected $description = 'Publish frontend assets and view files from easy framework to laravel application.';
